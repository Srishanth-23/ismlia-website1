      ...
      <div className="tabs-content">
        ...
        {activeTab === 'format' && (
          <div>
            ...
            <div style={{ background: 'rgba(212, 175, 55, 0.05)', border: '1px solid rgba(212, 175, 55, 0.25)', padding: '16px', borderRadius: 'var(--radius-sm)', marginTop: '15px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px' }}>
              <div>
                <h5 style={{ color: 'var(--primary)', margin: '0 0 4px 0', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  Official Poster Template (PPTX)
                </h5>
                <p style={{ fontSize: '0.82rem', color: 'var(--text-muted)', margin: 0 }}>
                  Download the official Microsoft PowerPoint A1-size presentation layout template.
                </p>
              </div>
              <a 
                href="/ISMLIA26_Poster_Template.pptx" 
                download="ISMLIA26_Poster_Template.pptx"
