    ...
    <footer className="footer">
      <div className="container footer-container">
        <div className="footer-col brand-col">
          ...
          <p>
            Organized by Department of Artificial Intelligence and Machine Learning & Department of Computer Science and Business Systems
            <br />
        ...
        <div className="footer-col">
          ...
          <p>Email: kirubakarann@citchennai.net / haripriyal.cse@citchennai.net</p>
        </div>
      </div>
